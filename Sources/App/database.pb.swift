...
struct GeocodingDatabase: Sendable {
  ...
  var index: GeocodingDatabase.SearchTree {
    get {_index ?? GeocodingDatabase.SearchTree()}
    set {_index = newValue}
  }
  ...
  var geotree: GeocodingDatabase.GeoTree {
    get {_geotree ?? GeocodingDatabase.GeoTree()}
    set {_geotree = newValue}
  }
  /// Returns true if `geotree` has been explicitly set.
  var hasGeotree: Bool {self._geotree != nil}
  ...
  struct Geoname: @unchecked Sendable {
    ...
    var alternativeNames: Dictionary<Int32,String> {
      get {_storage._alternativeNames}
...
extension GeocodingDatabase: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}geonames\0\u{1}index\0\u{1}languageIndex\0\u{1}geotree\0")
...
extension GeocodingDatabase.Geoname: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}name\0\u{2}\u{2}latitude\0\u{1}longitude\0\u{1}ranking\0\u{1}elevation\0\u{3}feature_code\0\u{3}country_iso2\0\u{3}admin1_id\0\u{3}admin2_id\0\u{3}admin3_id\0\u{3}admin4_id\0\u{3}timezone_index\0\u{1}population\0\u{1}alternativeNames\0\u{1}postcodes\0\u{3}country_id\0")
...
extension GeocodingDatabase.Geonames: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}geonames\0\u{1}timezones\0\u{1}languages\0")
...
extension GeocodingDatabase.GeoTree: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ordered\0\u{1}values\0")
...
extension GeocodingDatabase.SearchTree: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}ids\0\u{1}branches\0\u{1}buffer\0")
...
extension GeocodingDatabase.PartialName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}remaining\0")
